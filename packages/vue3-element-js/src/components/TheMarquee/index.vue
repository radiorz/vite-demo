...
if (!classOption || !classOption["key"]) {
  classOption["key"] = 0;
}
const wrap = templateRef(`wrap${classOption["key"]}`, null);
const slotList = templateRef(`slotList${classOption["key"]}`, null);
const realBox = templateRef(`realBox${classOption["key"]}`, null);
